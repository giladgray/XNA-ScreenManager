...
namespace ScreenManagement {
    ...
    public abstract class GameScreen {
        ...
        public Color TransitionWhite {
            get { return transitionWhite; }
        }

        Color transitionWhite = new Color(255, 255, 255);
        ...
        /// <summary>
        /// Gets the game instance that this screen belongs to, which is the
        /// same as that of its manager.
        /// </summary>
        ...
        bool UpdateTransition(GameTime gameTime, TimeSpan time, int direction) {
            ...
            if (((direction < 0) && (transitionPosition <= 0)) ||
                ...
                transitionWhite.A = TransitionAlpha;
                return false;
            }
            transitionWhite.A = TransitionAlpha;
        ...
        //    SpriteAlignment alignment, Rectangle? sourceRectangle = null, float rotation = 0f, float scale = 1.0f) {

        //        Vector2 origin = new Vector2(sprite.Width, sprite.Height);
        //        if(alignment & SpriteAlignment.Left == SpriteAlignment.Left)
